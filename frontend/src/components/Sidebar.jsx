...
const Sidebar = () => {
  ...
  const navigation = [
    ...
    },
    {
      ...
      dropdown: true,
      items: [
        { label: 'Top Stock 1', to: '/user/top-stock1' },
        { label: 'Top Stock 2', to: '/user/top-stock2' },
        { label: 'Top Stock 3', to: '/user/top-stock3' },
        { label: 'Top Stock 4', to: '/user/top-stock4' },
        { label: 'Top Stock 5', to: '/user/top-stock5' },
      ]
    },
    { 
      label: 'Profile', 
  ...
  return (
    <div className={`flex h-screen ${
      theme === "dark" ? "bg-gray-800 text-white" : "bg-blue-500 text-gray-900"
    }`}>
      <div className={`${
